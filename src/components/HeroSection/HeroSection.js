...
const HeroSection = () => {
  return (
    <div className="flex flex-col bg-bgColor2  px-[30px] py-[20px] md:px-[60px] lg:px-[100px] xl:px-[150px] lg:py-8">
      <HeroHeader />
      <div className="flex items-center justify-center my-8 md:my-16">
        <div className="flex flex-col w-full md:basis-1/2">
          <span className="font-plus font-bold text-white text-[30px] leading-[34px] md:text-[36px] md:leading-[45px] lg:text-[60px] lg:leading-[68px] mb-8">
            #1 Best Tattoo & Piercing Software
          </span>

          <span className="font-inter font-normal text-[14px] md:text-[18px] leading-[24px] md:leading-[30px] opacity-80 text-white mb-8">
        ...
        <div className="hidden md:basis-1/2 md:flex md:items-center md:justify-center">
          <img
            src={HeroBg}
            alt="background"
            className="md:w-[400px] xl:w-[550px] 2xl:w-[691px] 2xl:h-[520px]"
          />
        </div>
      </div>
    </div>
