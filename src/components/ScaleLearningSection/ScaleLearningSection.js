...
const ScaleLearningSection = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center px-[30px] md:px-[60px] lg:px-[150px] py-[30px] md:py-[60px] lg:py-[100px] w-full">
      <div className="basis-1/2 flex items-center justify-center mb-10 lg:mb-0">
        {/* place image instead of div */}
        <div className="bg-[#919192] w-[300px] h-[250px] md:h-[400px] md:w-[500px] lg:h-[520px] lg:w-[630px] rounded-md" />
      </div>

      <div className="basis-1/2 flex flex-col items-start lg:ml-20">
